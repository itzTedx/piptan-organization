            ...
            <div className="grid grid-cols-1 items-start gap-6 md:grid-cols-12 md:gap-10 lg:gap-16">
                ...
                <div className="order-2 flex flex-col gap-0 md:order-1 md:col-span-5">
                    {INDUSTRIES.map((industry, index) => {
                        ...
                        return (
                            <button
                                className={`group relative flex cursor-pointer items-start gap-4 border-border/50 border-t py-3 text-left transition-all duration-500 first:border-0 md:py-4 ${isActive
                                        ? "text-foreground"
                            ...
                            >
                                ...
                                <div className="flex flex-1 flex-col gap-1">
                                    <span
                                        className={`font-medium text-base transition-colors duration-500 sm:text-lg md:text-xl ${isActive ? "text-foreground" : ""
                                            }`}
                                    >
                                        {industry.title}
                                    </span>
